...
function PullLever( name )
	if name == "leverShape1" then 				--Level 2
		Game.ResetMaze()
	...
	elseif name == "leverShape2" then			--Level 3
		Game.ResetMaze()
	...
	elseif name == "leverShape3" then			--Level 4
		Game.ResetMaze()
	...
	elseif name == "leverShape4" then			--Level 5
		Game.ResetMaze()
		...
		Game.OpenMazeDoor( "gate_12Shape" )
		Game.OpenMazeDoor( "gate_13Shape" )
	elseif name == "leverShape5" then      		--Level 6
		Game.ResetMaze()
